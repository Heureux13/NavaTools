...
__doc__ = '''
Move grid line ends so top/left bubbles sit 1/2" outside the view border on sheet.
Keep right/bottom ends flush with the crop border.
Show bubbles only on top and left sides of the viewport.
'''
