...
__title__ = "Number 2"
__doc__ = """
Numbers all duct fittings in the model at once.
Keeps numbers together on runs, allows spreading if needed for signature matching.
Stores families processed afterwards.
"""
