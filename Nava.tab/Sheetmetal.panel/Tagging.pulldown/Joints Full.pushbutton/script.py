...
<<<<<<< HEAD:Nava.tab/Sheetmetal.panel/Tagging.pulldown/Joints Full.pushbutton/script.py
...
>>>>>>> parent of ed96062 (tagging):Nava.tab/Testing.panel/DO NOT PRESS.pushbutton/script.py
...
rp = RevitParameter(doc, app)# Code
# ==================================================
with Transaction(doc, "Tag Full Joints") as t:
=======
